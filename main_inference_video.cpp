...
int main(int argc, char* argv[]) 
{
	...
	if (!cap.isOpened())
		throw std::runtime_error("Unable to open video capture with input" + 0);
	...
	while (true) 
    {
        ...
        std::cout << "Detected: " << objects.size() << " Inference tim: " << inference_dt << " FPS: " << 1/inference_dt << std::endl;
        ...
        // std::cout << "Frame time: " << 1.0f/frame_dt << " Cap time: " << 1.0f/capture_dt << " Detect time: " << 1.0f/detect_dt << std::endl;
	}
